...
\item
  ...
  \item
    ...
    \code{\_hardfault\_handler}, then your program is likely to have
...
\item
  ...
  channel, its channel number is specified in the \code{.channel}
  field.  For example:
...
static const adc_cfg_t adc_cfg =
{
  ...
  the \code{.channels} field, for example:
