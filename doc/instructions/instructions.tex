...
\item Do not underestimate the blinky milestone.  It requires having a
  ...
  functional toolchainm, and the ability to download code into the
...
stream.  If you need an exception to this, see Daniel Morris with a
...
\item [Week~1]\mbox{}\\
  ...
  \item Read the System Design section in the Wacky Racers Guide.
...
%  \href{http://ecewiki.elec.canterbury.ac.nz/mediawiki/index.php/ENCE461_Altium_tutorial}{Altium tutorial on ecewiki}.
...
\item All decisions regarding legality of your dastardly devices are
  at the whim of Daniel Morris.  You can email Daniel at
  \href{mailto://daniel.morris@pg.canterbury.ac.nz}{daniel.morris@pg.canterbury.ac.nz}
